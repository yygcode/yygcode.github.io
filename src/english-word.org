...
* arrangement [ə'reɪn(d)ʒm(ə)nt] 整理, 准备
** Basic Explains
- n. 布置；整理；准备
** Web References
...
* reconcile ['rek(ə)nsaɪl] 调解, 使一致
** Basic Explains
- vt. 使一致；使和解；调停，调解；使顺从
** Web References
- reconcile :: 调和; 使和解; 使和好
- reconcile to :: 使顺从; 甘心; 使一致
- reconcile with :: 与和解; 与某人和好; 使一致
...
** Web References
- retain :: 保持; 保留; 保有
- retain earnings :: 留存收益; 保留盈余; 收益保留
- retain background :: 保持背景
* fidelity [fɪ'delɪtɪ] 精确
** Basic Explains
- n. 保真度；忠诚；精确；尽责
** Web References
- fidelity :: 保真度; 富达; 忠心
...
** Web References
- impact :: 撞击; 冲击; 影响
- Impact Exciter :: IMPACT EXCITER; Impact Exciter; 极限魅惑
- impact test :: 冲击测试; 冲击试验; 冲辉验
* transition [træn'zɪʃ(ə)n; trɑːn-; -'sɪʃ-] 过渡, 转换
** Basic Explains
- n. 过渡；转变；[分子生物] 转换；变调
** Web References
- transition :: 过渡; 转变; 转换
...
* prevail [prɪ'veɪl] 获胜, 战胜
** Basic Explains
- vi. 盛行，流行；战胜，获胜
** Web References
- prevail :: 流行; 占上风; 盛行
- prevail over :: 获胜; 占优势; 压倒
- Prevail on :: 说服; 劝说; 诱使
* intervening [,intə'vi:niŋ] 介入, 介于中间的
** Basic Explains
- v. 介入（intervene的ing形式）
- adj. 介于中间的
** Web References
- intervening :: 介入; 中介; 干预
- intervening variable :: 中介变量; 中介变项; 中介变数
- Intervening Variables :: 中介变项; 中介变量; 中介变数
* rationale
* rationale [,ræʃə'nɑːl] 基本原理，论据
** Basic Explains
- n. 基本原理；原理的阐述
** Web References
